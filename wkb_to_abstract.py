...
def multi_parse(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount, func: Callable[[bytearray, str, str, DimensionCount], Tuple[Any, bytearray]], repeat_count: int) -> ((Any, ...), bytearray):
...
def parse_Point(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> (Point, bytearray):
	return tuple(unpack(point_parser, wkb[:8 * dimension_count])), wkb[8 * dimension_count:]


def parse_LinearRing(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> (LinearRing, bytearray):
...
def parse_LineString(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> (LineString, bytearray):
	num_points, wkb = parse_UInt32(wkb, int_parser)
	points, wkb = multi_parse(wkb, int_parser, point_parser, dimension_count, parse_Point, num_points)
	return (num_points, *points), wkb


def parse_Polygon(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> (Polygon, bytearray):
...
def parse_MultiPoint(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> ([Point], bytearray):
	num_points, wkb = parse_UInt32(wkb, int_parser)
	points, wkb = multi_parse(wkb, int_parser, point_parser, dimension_count, parse_Geometry, num_points)
	return (num_points, *points), wkb


def parse_MultiLineString(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> ([LineString], bytearray):
...
def parse_MultiPolygon(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> ([Polygon], bytearray):
...
def parse_GeometryCollection(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> ([Geometry], bytearray):
...
def parse_Geometry(wkb: bytearray, int_parser: str, point_parser: str, dimension_count: DimensionCount) -> (Geometry, bytearray):
...
def wkb_to_abstract(wkb: bytearray) -> []:
